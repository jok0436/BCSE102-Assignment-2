...
CanvasDisplay.prototype.updateViewport = function (state) {
    ...
    playerXMinusView = center.x - (view.width / 2)
    lastPossibleCameraX = levelWidth - view.width
    playerYMinusView = center.y - (view.height / 2)
    lastPossibleCameraY = levelHeight - view.height
